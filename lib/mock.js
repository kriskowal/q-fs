...
var Fs = exports.Fs = function (files) {
    ...
    fs.list = function (path) {
        path = String(path);
        return Object.keys(find(path).get());
    };
    ...
    fs.read = function (path, flags, charset) {
        return fs.open(path).read(flags, charset);
    };
...
GenericNode.prototype.isFile = function () {
    var node = this.get();
    return typeof node !== "object" && typeof node !== "undefined";
};
